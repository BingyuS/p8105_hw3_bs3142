...
instacart %>%
  ...
  summarize(
    n_aisle = n(),
    n_obs = n_distinct(aisle))
```

    ## # A tibble: 134 x 3
    ##    aisle                  n_aisle n_obs
    ##    <chr>                    <int> <int>
    ##  1 air fresheners candles    1067     1
    ##  2 asian foods               7007     1
    ##  3 baby accessories           306     1
    ##  4 baby bath body care        328     1
    ##  5 baby food formula        13198     1
    ##  6 bakery desserts           1501     1
    ##  7 baking ingredients       13088     1
    ##  8 baking supplies decor     1094     1
    ##  9 beauty                     287     1
    ## 10 beers coolers             1839     1
    ## # ... with 124 more rows

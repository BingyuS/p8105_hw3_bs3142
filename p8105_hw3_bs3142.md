...
Comment: **CT, FL, NC** were observed at 7 locations in 2002.
...
![](p8105_hw3_bs3142_files/figure-markdown_github/spagetti%20plot_q1-1.png) Comment: The majority of the states had similar number of locations each year. However, there was one state that had spikes in the number of locations in 2007 and 2010.
...
|     2010|                       22.7|                                                                                                                                         3.6|
|  Comment|                          :|                                                                                                                                            |
|  In NY s|  tate, the means and stand|  ard deviations of the proportion of "Excellent" responses across locations in years 2002, 2006, and 2010 were similar (roughly around 22).|
...
![](p8105_hw3_bs3142_files/figure-markdown_github/scatterplot_q1-1.png) Comment: The clustering of average proportion of responses in each category suggested a similar proportion of responses are gathered each year. In general, people reported a majority of good responses.
...
There are **134** aisles, the aisle of **Fresh Vegetables** gets the most items ordered.
...
instacart %>%
  ...
  viridis::scale_color_viridis(
    name = "Number of items ordered per aisle"
  )
```
...
-   Precipitation, snowfull, snow depth, maximum and minimun temperatures are recorded by a total of **747** participating weather stations from 1981 to 2010.
-   All five measurements contain a large portion of missing values.
...
plot_snow = 
  ...
  stat_summary(fun.y = median, geom = "point", color = "blue", size = 2)
    labs(
      title = "The Distribution of Snowfall Values between 0mm and 100mm by Year",
      x = "Year",
      y = "Snowfall (mm)",
      caption = "Data from ny_noaa"
...
```
    ...
    ## $title
    ## [1] "The Distribution of Snowfall Values between 0mm and 100mm by Year"
    ## 
    ## $x
    ## [1] "Year"
    ## 
...
![](p8105_hw3_bs3142_files/figure-markdown_github/unnamed-chunk-10-1.png)
